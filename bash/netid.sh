...
requestedInterface=""
#all the line argument are accepted here:
while [ $# -gt 0 ]; do
    case "$1" in
    -v)
        verbose="yes"
...
# a list of all the system interface that the script will examine
IntArray=($(ip route | grep -w "Program" | awk '{print $4}'))


#examine through all the interface created above
